...
export class Control {
    ...
    moveIntoCenter() {
        const widhtCount = Math.floor(window.innerWidth / configData.gameMap.blockSize.width) + 2
        const heightCount = Math.floor(window.innerHeight / configData.gameMap.blockSize.height) + 2
